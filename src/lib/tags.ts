...
export type NameSegment = { type: 'text' | 'url' | 'tag'; value: string };

/**
 * Split a name string into text, URL, and hashtag segments for inline rendering.
 * URLs are matched first so that a URL containing # isn't misread as a tag.
 */
